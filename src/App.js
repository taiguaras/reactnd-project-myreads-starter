...
class BooksApp extends React.Component { 
  ...
  componentWillMount(){
    ...
    console.log("resposta api call",response)
  ...
  handleBooksCurrentlyReading(){

        //GET FULL ARRAY OF BOOKS AND FILTER ONLY THOSE WHO ARE currentlyReading -> returns an array of them
        const currentlyReading = wholeShelf.books.filter(s => s.shelf === "currentlyReading" ).map(book => book)

        //GET FULL ARRAY OF BOOKS AND FILTER ONLY THOSE WHO ARE wantToRead -> returns an array of them
        const wantToRead = wholeShelf.books.filter(s => s.shelf === "wantToRead" ).map(book => book)
    
        //GET FULL ARRAY OF BOOKS AND FILTER ONLY THOSE WHO ARE read -> returns an array of them
        const read = wholeShelf.books.filter(s => s.shelf === "read" ).map(book => book)      
    
        console.log("o maior experimento de todos","CR -> ", currentlyReading,"WR -> ", wantToRead, "R -> ",read)

        return currentlyReading;
  }

  handleBooksWantToRead(){
  ...
  render() {
    ...
    const aux = this.state.books;
    console.log("log do app books",this.state.books);   
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>      
                ...
                <Bookshelf groupOfBooks={this.handleBooksCurrentlyReading()} shelfName={"Currently Reading"}/>
                <Bookshelf groupOfBooks={this.handleBooksWantToRead()} shelfName={"Want to Read"}/>
                <Bookshelf groupOfBooks={this.handleBooksRead()} shelfName={"Read"}/>
